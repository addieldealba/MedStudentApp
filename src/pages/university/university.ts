...
import { UniversityDetailsPage } from '../university-details/university-details';
...
ionViewWillEnter(){
  ...
  private getLessons(): any{
    this.remoteService.getApiLessons().then((data) => {
      this.lessons = data;
      return 1;
    });
    this.loader.dismiss();
